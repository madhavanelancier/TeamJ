...
class MyTourAdap(private var items: ArrayList<OrderDetail>, private val context: Activity, val from:String) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{

    override fun onCreateViewHolder(viewGroup: ViewGroup, viewType:Int): RecyclerView.ViewHolder {
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                val productView = LayoutInflater.from(viewGroup.context).inflate(R.layout.trip_list_item, viewGroup, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                ...
                holder.request_name.setText(obj.created_at+" - "+obj.trip_timing)
                holder.r_type.setText(obj.adrs_type)
                holder.tours.setText(obj.user)
                holder.expenditure.setText(obj.city)
