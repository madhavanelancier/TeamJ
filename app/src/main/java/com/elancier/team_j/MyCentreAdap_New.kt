...
class MyCustomerAdap_New(private val CentreArrays: List<OrderDetail>, private val context: Context, private val listener: OnItemClickListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(viewGroup:ViewGroup, viewType:Int): RecyclerView.ViewHolder {
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                val productView = LayoutInflater.from(viewGroup.context).inflate(R.layout.customer_list_item_new, viewGroup, false)
        ...
        when (viewType) {
            ITEM_CONTENT_VIEW_TYPE -> {
                ...
                holder.viewDoctor.setOnClickListener {
                    editor.putString("cusid",CentreArrays[position].id.toString())
                    editor.putString("cusname",CentreArrays[position].customer_name.toString())
                    editor.commit()
    ...
    inner class ItemViewHolder internal constructor(rowView: View) : RecyclerView.ViewHolder(rowView), View.OnClickListener {
        ...
        internal lateinit var viewDoctor: Button
        ...
        init {
            ...
            viewDoctor=rowView.findViewById(R.id.call) as Button
